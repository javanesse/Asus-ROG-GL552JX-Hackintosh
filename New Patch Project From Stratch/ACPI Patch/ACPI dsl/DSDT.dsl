 ...
 * 2. fix parseop zero error - DSDT
 * ----
 * FIX error across ACPI's
 * ----
 * SSDT error
 * 3. SSDT-1 error parseop package - fix_PSS - SSDT-1
 * 4. SSDT-8 error parseop nameseg - [gfx0] Cleanup/Fix Errors (SSDT) - SSDT-8
 * 5. Rename _DSM to XDSM across ACPI's
 * 6. Fix _WAK Arg0 v2 - DSDT
 * 7. Fix hpet - DSDT
 * 8. smbus fix - DSDT
 * 9. IRQ Fix - DSDT
 * 10. Fix RTC - DSDT
 * 11. OS Check Fix - DSDT
 * 12. Add mchc - DSDT
 * 13. Add imei - DSDT
 * 14. Add DTGP - DSDT
 * 15. Haswell LPC - DSDT
 * 16. Rename SAT0 to SATA - Across ACPI's
 * 17. Rename GLAN to GIGE - DSDT
...
{
    /*
     * iASL Warning: There were 39 external control methods found during
     * disassembly, but only 33 were resolved (6 unresolved). Additional
...
WAK (Arg0)
    ...
    Scope (_GPE)
    {
        ...
        Method (_L0D, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            ...
            If (CondRefOf (\_SB.PCI0.RP04.GIGE))
            {
